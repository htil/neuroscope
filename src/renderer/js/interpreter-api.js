...
export const InterpreterAPI = class {
  constructor(workspace) {
    ...
    this.nativeFunctions = {
      ...
      mechdog_backward: this.wrapperFunctions.mechdog_backward,
      mechdog_forward_continuous: this.wrapperFunctions.mechdog_forward_continuous,
      mechdog_backward_continuous: this.wrapperFunctions.mechdog_backward_continuous,
      mechdog_drive: this.wrapperFunctions.mechdog_drive,
      mechdog_turn_left_steering: this.wrapperFunctions.mechdog_turn_left_steering,
